...
class RefreshableCredentials(Credentials):
    ...
    def __init__(self, access_key, secret_key, token, expiry_time, refresh_using, method, time_fetcher=..., advisory_timeout=..., mandatory_timeout=...) -> None:
        ...
    
    @classmethod
    def create_from_metadata(cls, metadata, refresh_using, method, advisory_timeout=..., mandatory_timeout=...): # -> Self:
        ...
