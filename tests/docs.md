...
1. UNIT ТЕСТЫ (RegisterRouter класс)
- Тестирование правильности настройки endpoint - проверка что configure() создает POST маршрут с корректным path
- Валидация response_model конфигурации - проверка что endpoint использует правильные схемы ответов
- Тестирование dependency injection настройки - проверка что все зависимости правильно подключены к endpoint
- Проверка Query параметров конфигурации - валидация настройки use_cookies параметра
...
3. FUNCTIONAL ТЕСТЫ (Бизнес-логика)
